...
TRACKS=(API-Testing Playwright Robot-Framework Performance-Testing DB-Design-SQL CLI-Essentials Security-Testing Accessibility-Testing Visual-Regression-Testing CI-CD-Pipeline Framework-Design OOP-Fundamentals Data-Structures-Algorithms Final-Project)
